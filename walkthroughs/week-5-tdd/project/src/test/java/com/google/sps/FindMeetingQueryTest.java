...
public final class FindMeetingQueryTest {
  ...
  public void noOptionsForTooLongOfARequest() {
    // The duration should not be longer than a day. This means there should be no options.
  ...
  public void noMandatoryAttendeesWithNoGaps() {
    ...
    Collection<Event> events =
        Arrays.asList(new Event("Event 1", TimeRange.WHOLE_DAY, Arrays.asList(PERSON_A)),
  ...
  @Test
  public void onlyConsiderRequiredAttendees() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times. The optional attendee with an all day event should not effect
    // this.
    //           |-------------C---------------|
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void optionalAttendeeChangesQueryResult() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times. The optional attendee with an event from 8:30 - 9:00 means only
    // the early and late partsof the day should be returned
    //
    // Events  :       |--A--||--C--||--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  public void justEnoughRoomWithOptionalAttendee() {
    // Have one person, but make it so that there is just enough room at one point in the day to
    // have the meeting. The optional attendee should be ignored since considering
    // their schedule would mean no time slots are returned.
    //
    // Events  : |--A--|     |----A----|
    // Day     : |---------------------|
    // Options :       |-----|
